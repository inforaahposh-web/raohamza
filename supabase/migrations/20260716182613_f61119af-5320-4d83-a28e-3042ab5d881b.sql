...
-- Site settings key/value JSONB store for all singleton sections
...
CREATE TABLE public.case_studies (
  ...
  outcome TEXT,
  funnel_html TEXT,
  ad_creatives JSONB NOT NULL DEFAULT '[]'::jsonb, -- [{url, type: image|video, caption}]
  campaign_stat_images JSONB NOT NULL DEFAULT '[]'::jsonb, -- [{url, caption}]
...
('stack', '{"items":[{"cat":"Ad Platforms","items":["Meta Ads","Google Ads","TikTok Ads","Snapchat Ads","LinkedIn Ads","YouTube Ads"]},{"cat":"Tracking","items":["Meta Pixel","Conversions API","Google Tag Manager","GA4","Looker Studio","Trackbox"]},{"cat":"Web & CMS","items":["Shopify","WordPress","Lovable"]},{"cat":"Automation","items":["Zapier","n8n","Make"]},{"cat":"CRM","items":["HubSpot","Go High Level","Zoho CRM"]},{"cat":"AI Copilots","items":["ChatGPT","Claude","Gemini"]}]}'),
